...
//  "If the program lacks structure, itâ€™s usually easier for me to add structure to the program first, and then make the change I need."
//  "In this case, I have a couple of changes that the users would like to make. First, they want a statement printed in HTML."
//    "Iâ€™m faced with adding conditional statements around every statement that adds a string to the result. That will add a host of complexity to the function. 
...
//    "But if I copy statement to htmlStatement, Iâ€™d need to ensure that any changes are consistent. Furthermore, as the rules grow in complexity, 
//       itâ€™s going to be harder to figure out where to make the changes and harder to do them without making a mistake."


// "...the first step is always the same. I need to ensure I have a solid set of tests for that section of code.
// "The larger a program, the more likely it is that my changes will cause something to break inadvertently”
...
//    see 'Write a Unit Test for JavaScript (super simple!) - using Mocha and Chai'Â https://www.youtube.com/watch?v=Rumf96j0cR0
